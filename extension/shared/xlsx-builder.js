...
<worksheet xmlns="http://schemas.openxmlformats.org/spreadsheetml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships">
  ...
  function buildWebsiteXlsx(leads) {
    ...
    const WEB_COLUMN_SPECS = [
      { header: "Company",                 width: 30, type: "str",  align: "left"  },
      { header: "Lead Score",              width: 14, type: "num",  align: "right" },
      { header: "Quality Tier",            width: 16, type: "str",  align: "left"  },
      { header: "Website",                 width: 34, type: "url",  align: "left"  },
      { header: "Primary Email",           width: 30, type: "str",  align: "left"  },
      { header: "Email Role",              width: 16, type: "str",  align: "left"  },
      ...
      { header: "Decision Maker Name",     width: 26, type: "str",  align: "left"  },
      { header: "Decision Maker Title",    width: 28, type: "str",  align: "left"  },
      { header: "Decision Maker Email",    width: 30, type: "str",  align: "left"  },
      { header: "Decision Maker LinkedIn", width: 40, type: "url",  align: "left"  },
      { header: "People Count",            width: 14, type: "num",  align: "right" },
      { header: "Address",                 width: 45, type: "str",  align: "left"  },
      { header: "City",                    width: 18, type: "str",  align: "left"  },
      { header: "State / Region",          width: 18, type: "str",  align: "left"  },
      { header: "Country",                 width: 15, type: "str",  align: "left"  },
