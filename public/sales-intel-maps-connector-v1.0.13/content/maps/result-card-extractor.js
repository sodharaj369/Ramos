...
(function (root, factory) {
  ...
  function isBusinessResultCard(cardEl) {
    ...
    if (cardEl.closest && cardEl.closest('div[role="main"], div.TIwYe, div.bJ181e')) {
    ...
    const hasPlaceLink = Boolean(href && (href.includes("/maps/place/") || placeId || href.includes("!3d") || href.includes("place_id") || href.includes("/maps/dir/")));
    if (!hasPlaceLink) {
