...
const requiredDocs = [
  ...
  'docs/RAMOS_WEBSITE_PHASE_7_REPORT.md',
  'docs/RAMOS_WEBSITE_PHASE_8_REPORT.md',
  'docs/RAMOS_FINAL_RELEASE_AUDIT.md',
  'docs/RAMOS_WEBSITE_SCRAPER_PHASE_0_1_AUDIT.md',
  'docs/RAMOS_RELEASE_CANDIDATE_CHECKLIST.md',
  'docs/RAMOS_RELEASE_CANDIDATE_REPORT.md',
  'docs/CHANGELOG.md',
  'docs/RAMOS_DOCUMENTATION_STATUS.md',
  'PILOT_READINESS.md',
